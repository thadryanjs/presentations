...
:::: {.columns}
::: {.column}
- Will see more on care density later 
- Number of zip codes range from 1-7
:::
...
# Care Density in our study

## Care Density by diagnosis
...
::: {.column width="65%"}
![](assets/images/care-density.png)
:::

::::

## Care Density by PCP in-network
...
::: {.column width="65%"}
![](assets/images/care-density-by-pcp-in-net.png)
:::
...
::: {.column width="65%"}
![](assets/images/care-density-and-num-prov-seen.png)
:::
